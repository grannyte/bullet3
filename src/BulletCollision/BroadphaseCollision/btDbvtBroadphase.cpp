...
void btDbvtBroadphase::rayTest(const btVector3& rayFrom, const btVector3& rayTo, btBroadphaseRayCallback& rayCallback, const btVector3& aabbMin, const btVector3& aabbMax)
{
	...
	// the preallocated per-thread stacks are disabled upstream (tsan issue), so this always uses a
	// local one -- which is also what makes rayTest independent of any thread index
